        ...
        AnimationTimer frameRateMeter = new AnimationTimer()
        {
            ...
            public void handle(long now)
            {
                ...
                if (arrayFilled)
                {
                    ...
                    sliderWrapper.setText(String.format("Current frame rate: %.1f", frameRate));
                }
            }
        };
...
//        setUpConstraints(root);
        ...
        Building notreDame = new Building(buildingImage);
        notreDame.angleProperty().bind(buildingAngle);
        notreDame.prefWidthProperty().bind(width);
        notreDame.prefHeightProperty().bind(height);
        notreDame.depthProperty().bind(depth);
    ...
    private VBox sliderArea(Node focusser)
    {
        ...
        Slider zoomSlider = new FocusRejectingSlider(-200, 5000, zoom.getValue(), focusser);
